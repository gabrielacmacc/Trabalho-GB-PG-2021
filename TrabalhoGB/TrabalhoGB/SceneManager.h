...
public:
	...
	bool TestPositionFilter(int filter_number);
	bool TestPositionSt(int sticker_number);
...
private:
	...
	float xPosFil[8], yPosFilt, xSizeFilt, ySizeFilt, xPosSt[8], yPosSt, xSizeSt, ySizeSt, image_width, image_height;
	string texture_name;
	double xpos, ypos;
	int mouse_condition;
};